...
const voteModule = sdk.getVoteModule(
  "0x51EA4c8a68BeB2d81545D1dF5E504407f7f26d00"
);
...
const App = () => {
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Welcome to OnlyGodCanJudgeUsDAO</h1>
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1>OnlyGodCanJudgeUsDAO Member Page</h1>
  ...
  return (
    <div className="mint-nft">
      <h1>Mint your free OgcjuDAO Membership NFT</h1>
